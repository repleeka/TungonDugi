      ...
      {articles.map((article) => (
        ...
        >
          <div className="p-6">
            ...
            <h3 className="text-xl font-bold mb-2 text-black dark:text-white">{article.title}</h3>
            <p className="text-gray-600 dark:text-gray-300 mb-4 text-justify">{article.excerpt}</p>
            <a
              href={article.link}
              target="_blank"
              rel="noopener noreferrer"
              className="text-black dark:text-white font-medium hover:underline transition-colors flex items-center"
            >
              Read More
              <svg
